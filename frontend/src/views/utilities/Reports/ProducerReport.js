...
import { PRODUCER_REPORT_URL, SEARCH_PRODUCERS_URL, ESBLOGS_REPORT_URL } from '../../../UrlPath.js';
...
// Data to copy or export to xlsx or pdf in table
  ...
  XLSX.writeFile(wb, 'ProducerReportData.xlsx');
};
...
const exportToPDF = () => {
  ...
  doc.save('ProducerReportData.pdf');
};
  ...
  return (
    <>
      <MainCard
        title={<span style={{ color: 'black ', fontWeight: 'bold', fontSize: '24px' }}>{t('ProducerReport')}</span>}
          ...
          <Table id="tableId">
            ...
            <TableBody>
                ...
                if (rows.length === 0) {
                  ...
                  return rows.slice(startIndex, endIndex).map((row) => (
                    <TableRow key={row.Id}>
                      ...
                      <TableCell>{row.In_Request}</TableCell>
                      <TableCell>{row.Out_Response}</TableCell>
                    </TableRow>
                  ));
                }
              })()} */}
              ...
              <TableRow>
                ...
                <TableCell>GetServices</TableCell>
                <TableCell>{JSON.stringify({ system: "ecnps" })}</TableCell>
                <TableCell>{JSON.stringify({ "details": "pgs1 api is called - e-cnps details sent" })}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>19d9b4ff-4deb-4dc3-816e-35f69eb148bd</TableCell>
                <TableCell>2023-09-13 08:30:12</TableCell>
